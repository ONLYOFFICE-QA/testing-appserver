...
shared_examples_for 'documents_select_all_checkbox' do |product, folder, all_files_and_folders, document_name,
  spreadsheet_name, presentation_name, audio_name, archive_name, picture_name, folder_name|
  it "[#{product}][#{folder}] `Select all` checkbox works" do
    documents_page.select_all_files
    expect(documents_page).to be_files_checked(all_files_and_folders)
  end

  it "[#{product}][#{folder}] `Select all Documents` works" do
  ...
  it "[#{product}][#{folder}] `Select all Media` works" do
  ...
  it "[#{product}][#{folder}] `Select all Presentations` works" do
  ...
  it "[#{product}][#{folder}] `Select all Spreadsheets` works" do
  ...
  it "[#{product}][#{folder}] `Select all Files` works" do
  ...
  it "[#{product}][#{folder}] `Select all Images` works" do
  ...
  it "[#{product}][#{folder}] `Select all Archives` works" do
  ...
  it "[#{product}][#{folder}] `Select all Folders` works" do
  ...
  it "[#{product}][#{folder}] `Select all All` works" do
