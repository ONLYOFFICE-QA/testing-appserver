...
shared_examples_for 'documents_users_groups_filter' do |folder, files_array, folder_name, admin, user,
  admin_group, user_group|
  it "[#{folder}] `Group` filter works" do
  ...
  it "[#{folder}] `User` filter works" do
